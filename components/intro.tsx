...
export default function Intro() {
  return (
    <div className='bg-slate-950 flex min-h-screen w-screen flex-col items-center justify-center py-20 text-slate-200'>
      <div className='container mx-auto max-w-5xl px-6'>
        <div className='flex flex-col items-center text-center'>
          ...
          <div className='mt-10 space-y-4'>
            <h1 className='text-6xl font-extrabold tracking-tight text-slate-50 md:text-7xl'>
              Thammajade
            </h1>
            <h3 className='bg-gradient-to-r from-sky-400 to-emerald-600 bg-clip-text text-2xl font-bold text-transparent md:text-3xl'>
              Fullstack Developer
            </h3>
            <p className='mx-auto mt-6 max-w-2xl text-lg font-light leading-relaxed text-slate-400 md:text-xl'>
              Full-stack Developer with 4 years of experience, specialized in building complex
              enterprise systems with React 19 and Next.js. Passionate about AI-driven workflows and
              scalable state management using Valtio.
            </p>
          </div>

          {/* Quick Info Grid */}
          <div className='mt-12 grid w-full max-w-2xl grid-cols-1 gap-y-4 gap-x-12 text-start md:grid-cols-2'>
            <div className='flex items-center space-x-4 rounded-lg border border-slate-800/50 bg-slate-900/40 p-3'>
              <svg
          ...
          <div className='mt-12 flex flex-col items-center gap-8 md:flex-row'>
            <div className='flex items-center gap-8'>
              <a
                ...
                target='_blank'
                rel='noreferrer'
                className='text-slate-400 transition-colors duration-300 hover:text-emerald-400'
              >
            ...
            <button
              ...
              className='group relative flex items-center justify-center overflow-hidden rounded-2xl px-10 py-4 font-bold text-white transition-all duration-300'
            >
