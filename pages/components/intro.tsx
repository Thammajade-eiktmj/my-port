              ...
              <div className='justify-self-end rounded-[10px] p-10'>
                <div className='flex flex-col items-center justify-center justify-self-end'>
                  ...
                  <button
                    ...
                    type='button'
                    className='group relative mt-6 mb-2 mr-2 inline-flex items-center justify-center overflow-hidden rounded-lg bg-green-400/50 p-0.5 text-sm font-medium text-slate-50 shadow-2xl shadow-slate-900/70 hover:text-white focus:outline-none focus:ring-4 focus:ring-green-800 group-hover:from-green-400 group-hover:to-blue-600'
                  >
